...
path = "/home/kirke/Schreibtisch/ma/python/cue_integration/Results/pilot_3_angle"
os.chdir(path)
# Read text File
...
folder_path='/home/kirke/Schreibtisch/ma/python/cue_integration/Results/pilot_3_angle'
...
print(combined_df)
combined_df.to_csv('/home/kirke/Schreibtisch/ma/python/cue_integration/merged_1.txt', sep='\t', index=False)
...
pf.savefig('/home/kirke/Schreibtisch/ma/python/figures/pilot_3_angle_points')
plt.show()
...
plt.savefig('/home/kirke/Schreibtisch/ma/python/figures/width_pilot_3')
plt.show()
